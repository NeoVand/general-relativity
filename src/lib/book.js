...
export const toolSpecs=[
 {name:'show_chapter',description:'Open a chapter at its beginning without starting audio. Use for take me to, go to, or open a chapter. Use an exact page ID from the book map.',parameters:{type:'object',properties:{page:{type:'string'}},required:['page'],additionalProperties:false}},
 ...
 {name:'show_passage',description:'Navigate to a book page and highlight an exact passage WITHOUT starting narration. Use IDs returned by book tools. Never invent a target.',parameters:{type:'object',properties:{page:{type:'string'},passage:{type:'string'}},required:['page','passage'],additionalProperties:false}}
