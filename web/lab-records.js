...
export const labRecords={
 star:{labLabel:'Stellar structure lab',hint:'Increase the central density. The radius uses a fixed scale; watch whether a denser star is also a larger star. Colour shows density relative to the centre.',id:'star',version:1,chapter:17,title:'Build a star from its centre',question:'Choose a central density. Follow the pressure outward until it reaches zero: that is the surface of your star.',
  ...
  parameters:[{id:'central',label:'Central rest-mass density',min:.02,max:2,step:.02,value:.2},{id:'step',label:'Radial step',options:[.02,.01,.005,.0025],value:.01}],
 },
 distances:{labLabel:'Cosmology lab',hint:'Change H₀ first, then the matter fraction. The dots mark your source redshift. Axes keep a common scale unless a curve needs more room.',id:'distances',version:1,chapter:19,title:'Ask the universe three distance questions',question:'Which distance did the observation actually measure?',
 ...
 photon:{labLabel:'Light and observers lab',hint:'Each wave strip shows the same amount of local time. More crests mean a higher measured frequency. The markers below locate the two measurement events.',id:'photon',version:1,chapter:17,title:'Follow the photon. Ask each observer.',question:'Send light between two observers. Change their heights and motion, and compare the frequencies they measure.',
 ...
 evolution:{labLabel:'Numerical relativity lab',hint:'Compare Euler with RK4, then reduce the step. A curve can look convincing while its constraint residual reveals an error.',id:'evolution',version:1,chapter:20,title:'Make a universe—and audit the answer',question:'Will a smaller time step repair the apparent motion, the constraint, or both?',
  ...
  parameters:[{id:'method',label:'Integration method',optionLabels:{euler:'Euler',rk4:'RK4'},options:['euler','rk4'],value:'euler'},{id:'step',label:'Requested time step',options:[.4,.2,.1,.05,.025],value:.2},{id:'duration',label:'Final time',min:1,max:8,step:.5,value:4},{id:'view',label:'Plot',optionLabels:{scale:'Expansion',constraint:'Constraint'},options:['scale','constraint'],value:'scale'}],
 },
};
