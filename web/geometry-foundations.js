...
import {initParticleFlow} from './particle-flow-experience.js';
import {initFluidShear} from './fluid-shear-experience.js';
...
export function initGeometryFoundations() {
  const cleanups=[initVectorFields(),initParallelTransport(),initFlowOrder(),initParticleFlow(),initFluidShear()];
