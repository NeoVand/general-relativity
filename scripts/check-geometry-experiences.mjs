...
import {surfaceHeight,surfacePoint,surfaceDerivatives,chartToSurface,surfaceToChart,inChart,SURFACE_CHART_RADIUS,MERCURY,perihelionAdvance,orbitAt,orbitCurve} from '../web/geometry-experiences.js';
...
try{
 for(const width of [1440,390])for(const theme of ['light','dark']){
  const page=await browser.newPage({viewport:{width,height:width===390?844:1100},reducedMotion:'reduce'});page.on('pageerror',e=>errors.push(e.message));
