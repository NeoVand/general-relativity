...
const visual = '[data-scene],[data-visual-lesson],[data-geometry-experience],[data-curvature-experience],[data-relativity-lab],[data-mechanics-experience],figure.diagram';
const clean = element => {
